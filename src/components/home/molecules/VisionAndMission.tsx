        ...
        <Box className="space-y-20">
          <Grid container spacing={6} alignItems="center">
            <Grid item xs={12} md={6}>
              <Box className={isTablet ? "text-center max-w-lg mx-auto" : "max-w-lg"}>
                <Typography
                  variant="h2"
                  className={`text-3xl font-bold mb-6 relative ${isTablet ? "after:left-1/2 after:-translate-x-1/2" : ""}`}
                  sx={{
                    position: "relative",
                    "&::after": {
                      content: '""',
          ...
          <Grid container spacing={6} alignItems="center" direction={isTablet ? "column-reverse" : "row"}>
            <Grid item xs={12} md={6}>
              <Box className="rounded-lg overflow-hidden shadow-2xl">
                <Box
                  component="img"
            ...
            <Grid item xs={12} md={6}>
              <Box className={isTablet ? "text-center max-w-lg mx-auto" : "max-w-lg"}>
                ...
                <Typography variant="body1" className="text-gray-400 mt-8">
                  Our mission is to democratize access to advanced robotics technology by developing solutions that are not only powerful and precise but also accessible, scalable, and sustainable. We are committed to reducing the environmental footprint of industrial operations while simultaneously improving productivity and worker safety through thoughtful automation that complements human expertise.
                </Typography>
              </Box>
            </Grid>
          </Grid>
