  ...
  return (
    <Box id="features" className="py-20 bg-[#121212]">
      <Container>
        ...
        <Typography
          variant="subtitle1"
          className="text-xl text-gray-400 mb-12 text-start max-w-3xl mx-auto"
        >
        ...
        <Grid container spacing={4} justifyContent="center">
            ...
            <Card className="bg-gray-800 h-full transition-transform duration-300 hover:-translate-y-2 hover:shadow-xl">
              <CardContent className="p-6 text-center">
                ...
                <Typography variant="body2" className="text-gray-400">
                  ...
                  through redundant systems and predictive maintenance.
                </Typography>
              </CardContent>
            </Card>
          </Grid>
            ...
            <Card className="bg-gray-800 h-full transition-transform duration-300 hover:-translate-y-2 hover:shadow-xl">
              <CardContent className="p-6 text-center">
                ...
                <Typography variant="body2" className="text-gray-400">
                  ...
                  costs through improved efficiency and optimized resources.
                </Typography>
              </CardContent>
            </Card>
          </Grid>
          ...
          <Grid item xs={12} sm={6} md={4}>
            <Card className="bg-gray-800 h-full transition-transform duration-300 hover:-translate-y-2 hover:shadow-xl">
              <CardContent className="p-6 text-center">
                <Box className="text-4xl text-green-500 mb-4"></Box>
                <Typography variant="h5" className="font-semibold mb-3">
                  Precision & Consistency
                </Typography>
                <Typography variant="body2" className="text-gray-400">
                  Our systems deliver sub-millimeter precision with consistency,
                  ensuring superior product quality and reducing defects.
                </Typography>
              </CardContent>
            </Card>
          </Grid>
